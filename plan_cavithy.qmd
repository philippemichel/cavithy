---
subtitle: "Plan d'analyse statistique - V3.1"
cache: true
lof: false
lot: false
---
...
Passé cette étape, les critères de jugements manquants seront imputés à l'aide d'une méthode d'\gls{mice}, celle des données continues sera effectuée selon la méthode *predictive mean matching*. Les résultats obtenus sur chaque jeu imputé seront ensuite combinés à l'aide de la règle de Rubin (package `missMDA`[@miss]).
...
L’analyse principale sera réalisée sur tous les patients inclus. Une analyse complémentaire en population \gls{itt} modifiée sera réalisée avec le même protocole. 
...
On comparera l'évolution du taux de PTH à l'inclsion puis J0, J2 & J15 post opératoire  par le même protocole que pour le critère 4.
